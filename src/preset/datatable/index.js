export default {
  ...
  header: ({ props }) => ({
    class: [
      ...
      // Color
      "bg-primarySurfaceDark/100 dark:bg-surface-800",
      "border-surface-200 dark:border-surface-700",
      "text-[#686B8A] dark:text-white/80 text-xs"
    ]
  }),
  table: {
  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        "font-bold text-sm text-grey-500",
        ...
        // Color
        (props.sortable === "" || props.sortable) && context.sorted ? "bg-primary-50 text-primary-700" : "bg-primarySurfaceDark text-[#686B8A]",
    ...
    filteroperatordropdown: {
      ...
      item: ({ context }) => ({
        class: [
          ...
          { "bg-primarySurfaceDark dark:bg-surface-600/60 text-surface-700 dark:text-white/80": context.focused && !context.selected },
    ...
    headercheckbox: {
      ...
      box: ({ props, context }) => ({
        class: [
          ...
          // Colors
          {
            "border-surface-200 bg-surface-0 dark:border-surface-700 dark:bg-surface-900 bg-white": !context.checked,
  ...
  bodyrow: ({ context, props }) => ({
    class: [
      // Color
      "dark:text-white/80",
      { "bg-primarySurface/50 text-primary-700 dark:bg-primary-400/30": context.selected },
